...
public class MemberContext extends User implements OAuth2User {
    ...
    public MemberContext(MemberEntity member, List<GrantedAuthority> authorities) {
    ...
    public MemberContext(MemberEntity member, List<GrantedAuthority> authorities, Map<String, Object> attributes, String userNameAttributeName) {
